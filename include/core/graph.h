...
protected:
  ...
  TensorVec tensors;   // tensors in the graph
  OpVec ops;           // operators in the graph
...
public:
  ...
  string
  toString() const override; // return the string representation of the graph
   ...
   */
  bool topo_sort(); // topological sort
